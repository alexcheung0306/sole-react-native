import { View, TouchableOpacity, ScrollView, Text, RefreshControl, Dimensions } from 'react-native';
...
export default function SettingsScreen() {
  ...
  // Hardcoded video URI - replace with your video URI
    ...
    <>
      <View className="flex-1 bg-black">
        ...
        <ScrollView
          ...
          <View className="mb-8 border border-red">
            <VideoPlayer
              uri={hardcodedVideoUri}
              width={width - 32}
              aspectRatio={16 / 9}
              autoPlay={true}
              loop={true}
